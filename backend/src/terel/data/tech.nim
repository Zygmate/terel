type
  Discipline* = enum
    Herbology, Chemistry, Electric, Explosives, GunSmithy, Mechanical, Smithy, Therapeutics
  Tech* = object of RootObj
    id*: int
    name*: string
    ...
    component2*: string
    description*: string
  HealingSalve* = object of Tech
  FatigueRestorer* = object of Tech
  PoisonCure* = object of Tech
  FatigueLimiter* = object of Tech
  AccelerateHealing* = object of Tech
  WonderDrug* = object of Tech
  CureAll* = object of Tech
  StrongPoison* = object of Tech
  Charges* = object of Tech
  AnimalScent* = object of Tech
  CorrosiveAcid* = object of Tech
  Hallucinate* = object of Tech
  Paralyzer* = object of Tech
  Anaesthisizer* = object of Tech
  ElectricLight* = object of Tech
  ChargedRing* = object of Tech
  FlowSpectrometer* = object of Tech
  ShockingTraffic* = object of Tech
  ChapeuOfMagneticInversion* = object of Tech
  HealingJacket* = object of Tech
  TeslaRod* = object of Tech
  MolotovCocktail* = object of Tech
  FlashGrenade* = object of Tech
  SmokeGrenade* = object of Tech
  StunGrenade* = object of Tech
  ExplosiveGrenade* = object of Tech
  FireObstruction* = object of Tech
  Dynamite* = object of Tech
  HandCraftFlintlock* = object of Tech
  FineRevolver* = object of Tech
  RepeaterRifle* = object of Tech
  HushedRevolver* = object of Tech
  LookingGlassRifle* = object of Tech
  HandCannon* = object of Tech
  ElephantGun* = object of Tech
  SpikeTrap* = object of Tech
  TrapSpringer* = object of Tech
  AutoSkeletonKey* = object of Tech
  EyeGear* = object of Tech
  BearTrap* = object of Tech
  ClockworDecoy* = object of Tech
  MechanizedArachnid* = object of Tech
  PureOre* = object of Tech
  BalancedSword* = object of Tech
  FeatherWeightAxe* = object of Tech
  DwarvenGauntlets* = object of Tech
  HelmetOfVision* = object of Tech
  FeatherWeightChainmail* = object of Tech
  ElitePlatemail* = object of Tech
  ElixirOfPersuasion* = object of Tech
  ElixirOfPhysicalProwess* = object of Tech
  LiquidOfAwareness* = object of Tech
  TonicOfIncreasedReflexes* = object of Tech
  MindMarvel* = object of Tech
  Energizer* = object of Tech
  Revitalizer* = object of Tech
